...
app.get('/course/:studentId/:courseName', fetchStudent, fetchCourse, (req, res) =>{
    res.json({course: req.course});
})

//route to get certificate if course is completed
app.post('./generate-certificate', fetchStudent, fetchCourse, checkCourseCompletion, generateCertificate);
